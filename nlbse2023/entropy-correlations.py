...
for project_name in EXPERIMENT_PROJECTS_LIST:
    print(f'Creating entropy correlations for project: {project_name}')
    ...
    output_path = f'/home/adriano/Projects/phd/surprisal-se/ast-edge-entropy/nlbse2023/experiment-data/{project_name}/correlations'
    ...
    # print(len(ax))
    # print(fig)
    sns.heatmap(corr_matrix, annot=True, xticklabels=True, yticklabels=True, vmax=1, vmin=0, cbar=False, cmap=sns.cubehelix_palette(start=3, rot=-.5, as_cmap=True, dark=0.5, light=0.99))
    title = project_name
    ...
    plt.savefig(f'/home/adriano/Projects/phd/surprisal-se/ast-edge-entropy/nlbse2023/experiment-data/{project_name}/correlations/{project_name}-annotated.png', dpi=300, bbox_inches='tight')
    plt.close()
